...
<body>
    <div class="container">
        ...
        <table border="1" align="center" width="70%">
            ...
            <body>
                <?php $spaceshipLuggageData = $SpaceshipC->show_Spaceship_Luggage(); // Assuming $SpaceshipC is an instance of SpaceshipC
    ...
    <form action="dashSpaceship.php" method="POST" onsubmit="return validateUpdateSpForm()">
   
    <div class="form-group">
        <div class="container">
            <label for="update_id_sp">ID Spaceship:</label>
        ...
        <div class="form-group">
            <label for="update_NbSp_place">Number of Places</label>
            <input type="number" id="update_NbSp_place" name="NbSp_place" placeholder="Enter Number of Places">
        </div>
        <div class="form-group">
            <label for="update_NbSp_voyage">Number of Voyages</label>
            <input type="number" id="update_NbSp_voyage" name="NbSp_voyage" placeholder="Enter Number of Voyages">
        </div>
        <div class="form-group">
            <label for="update_description_SP">Description</label>
            <textarea id="update_description_SP" name="description_SP" placeholder="Enter Description"></textarea>
        </div>
    ...
    <script>
      function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this spaceship?")) {
        ...
        function PopupUpdateSPForm(id_sp, Sp_model, NbSp_place, NbSp_voyage, description_SP) {
            document.getElementById("update_id_sp").value = id_sp;
            document.getElementById("update_Sp_model").value = Sp_model;
            document.getElementById("update_NbSp_place").value = NbSp_place;
            document.getElementById("update_NbSp_voyage").value = NbSp_voyage;
            document.getElementById("update_description_SP").value = description_SP;
            toggleUpdateSPPopup(); // Show
        }

        function validateFormSpUpdata() {
