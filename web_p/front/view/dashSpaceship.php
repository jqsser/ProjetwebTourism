...
.page-title {
  ...
  <body>    
    <div class="container">
    <a href="readassur.php" class="move-left-top" style="color: blue;">go to list of client's Luggage </a>
    <div class="center">

    <h1 class="page-title">List of Spaceship's</h1>
    <h2>
      ...
      <tbody>
          ...
          { ?>
              <tr>
                  ...
                  <td align="center">
                      <form method="POST" action="updateSpaceship.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $rec['id_sp']; ?> name="id_sp">
                      </form>
                  </td>
                  <td>
                      <a href="deleteSpaceship.php? id_s=<?php echo $rec['id_sp']; ?>">Delete</a></td>
              </tr>
        <?php } ?>
      </tbody>
  </table>         
