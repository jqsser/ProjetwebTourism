...
require(__DIR__ . '/../Model/Spaceship.php');
...
public function get_Spaceship_By_Id($id_sp)
{
    try {
        $db = config::getConnexion();
        $query = $db->prepare('SELECT * FROM Spaceship WHERE id_sp = :id_sp');
