...
if (
    ...
    if (
        ...
        // Redirect to dashSpaceship.php after adding the spaceship
...
<body>
    ...
    <div class="popup" id="popup">
        ...
        <h2>Ajouter Spaceship</h2>
        <form action="" method="POST" onsubmit="return validateForm()">
            <div class="form-group">
                <label for="id_sp">ID</label>
                <input type="text" id="id_sp" name="id_sp" placeholder="Enter ID">
            </div>
            <div class="form-group">
