...
.page-title {
  ...
  <body>    
    <div class="container">
    <a href="readassur.php" class="move-left-top" style="color: blue;">go to list of Luggage's </a>
    <div class="center">
          ...
          { ?>
              <tr>
                ...
                <td><?= $rec['weight_Lu'] ?></td>
                  ...
                  <td align="center">
                      <form method="POST" action="updateLuggage.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $rec['id_luggage']; ?> name="id_luggage">
                      </form>
                  </td>
                  <td>
                      <a href="deleteLuggage.php? id_luggage=<?php echo $rec['id_luggage']; ?>">Delete</a></td>
              </tr>
        <?php } ?>
      </tbody>
  </table>         
