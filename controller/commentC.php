...
class commentc{
    ...
    {
        $sql = "INSERT INTO crud_hadil ( id_c, content_c, date_c, rating_c) VALUES (:id_c,:content_c,:rating_c, :date_c)";
    ...
    public function recupererComment($id_c){
        $sql="SELECT * from crud_hadil where id_c=$id_c";
        $conn = new config();
    ...
    {
        $sql = "DELETE FROM crud_hadil WHERE id_c = :id_c";
        $db = config::getConnexion();
        $req = $db->prepare($sql);
